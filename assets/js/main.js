...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function openMenu()  { overlay.classList.add('open');    menuBtn.textContent = '✕'; menuBtn.setAttribute('aria-expanded', 'true');  }
  function closeMenu() { overlay.classList.remove('open'); menuBtn.textContent = '☰'; menuBtn.setAttribute('aria-expanded', 'false'); }
